...
if building:
    ...
    if uuid == '':
        ...
        result = subprocess.call('codesign --force --deep --timestamp --options runtime --sign "Developer ID Application: Telegram FZ-LLC (C67CF9S4VU)" Telegram.app --entitlements "../../Ansible/Ansible/Ansible.entitlements"', shell=True)
        if result != 0:
