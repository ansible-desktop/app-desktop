...
if [ "$BuildTarget" == "mac" ]; then
  ...
  if [ ! -d "$BackupPath" ]; then
    BackupPath="/mnt/c/Ansible/Projects/backup/tdesktop"
  fi
else
...
MacUpdateFile="ansible-update-mac-x64-$AppVersion$ArtifactSuffix"
ARMacUpdateFile="ansible-update-mac-arm-$AppVersion$ArtifactSuffix"
MacSetupFile="ansible-setup-mac-$AppVersionStr$ArtifactSuffix.dmg"
WinUpdateFile="ansible-update-win-x86-$AppVersion$ArtifactSuffix"
WinSetupFile="ansible-setup-win-x86-$AppVersionStr$ArtifactSuffix.exe"
WinPortableFile="ansible-portable-win-x86-$AppVersionStr$ArtifactSuffix.zip"
Win64UpdateFile="ansible-update-win-x64-$AppVersion$ArtifactSuffix"
Win64SetupFile="ansible-setup-win-x64-$AppVersionStr$ArtifactSuffix.exe"
Win64PortableFile="ansible-portable-win-x64-$AppVersionStr$ArtifactSuffix.zip"
WinArmUpdateFile="ansible-update-win-arm-$AppVersion$ArtifactSuffix"
WinArmSetupFile="ansible-setup-win-arm-$AppVersionStr$ArtifactSuffix.exe"
WinArmPortableFile="ansible-portable-win-arm-$AppVersionStr$ArtifactSuffix.zip"
LinuxUpdateFile="ansible-update-linux-x64-$AppVersion$ArtifactSuffix"
LinuxSetupFile="ansible-setup-linux-x64-$AppVersionStr$ArtifactSuffix.tar.xz"
