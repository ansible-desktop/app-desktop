...
bool MoveLegacyAlphaFolder() {
	// Апстрим переносил сюда свои прежние папки TelegramAlpha_data и
	// TelegramBeta_data. Для нас это папки ЧУЖОГО приложения, и перенос
	// означал бы забрать данные установленного рядом Telegram в нашу
	// переносную папку. Своих устаревших имён у нас нет.
	return true;
}
...
int Launcher::exec() {
	...
	// chosen: a translocated bundle never sees its AnsibleForcePortable.
